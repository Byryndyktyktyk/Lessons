public class Lesson1 {
    public static void main(String[] args) {
        ...
        System.out.println("Общая стоимость товара без скидки = " + g);
        ...
        a = b;
        b = c;
        System.out.println("С помощью арифметических операций  a = " + a);
        System.out.println("С помощью арифметических операций  b = " + b);
        int a1;
        int b1;
        a1 = 1;
        b1 = 2;
        ...
        b1 = a1 + b1;
        a1 = -a1 + b1;
        System.out.println("С помощью побитовой операции  a = " + a1);
        System.out.println("С помощью побитовой операции  b = " + b1);
